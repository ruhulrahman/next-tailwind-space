        ...
        <motion.div
            ...
            <div className="h-full w-full flex flex-col gap-5 justify-center m-auto text-start">
                ...
                <motion.div
                    ...
                    <p className='text-justify'>I am a Full Stack Software Engineer with 9+ years of experiences specializing in backend technologies like PHP, Laravel, Java, Spring Boot, Node.js, Nest.js, Typescript and Express.js. I have expertise in databases like MySQL, MongoDB, PostgreSQL, indexedDB, Redis, as well as frontend frameworks including Vue.js, React.js, Next.js, Nuxt.js, Quasar Framework, Redux, Tanstack Query for state management and Bootstrap, Tailwind CSS for responsive UI design, and Figma for UI/UX design. I also have experience working with version control systems like Git, GitHub, and Bitbucket. Websocket and Socket.io for real-time communication. With a proven track record of delivering robust solutions for government, educational, financial, and HR projects, I combine technical expertise with a passion for clean, scalable code. Whether crafting enterprise systems or intuitive user experiences, I ensure every project achieves the best results.
